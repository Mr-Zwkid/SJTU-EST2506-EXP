...
// volatile uint8_t LeftShift = 0x01;		// 右移变量 

// uint8_t SW1_cnt = 0;			// 按键SW次数 
// uint8_t SW1_state = 0;			// 按键SW的状态 0按下，1没按
...
// 			{
// 			case 0:
// 				I2C_CurFlashTime = 500;
// 				break;
// 			case 1:
// 				I2C_CurFlashTime = 1000;
// 				break;
// 			case 2:
// 				I2C_CurFlashTime = 2000;
// 				break;
// 			case 3:
// 				I2C_CurFlashTime = 200;
// 				break;
// 			default:
// 				break;
// 			}

// 			if (++ i2c_flash_cnt >= I2C_CurFlashTime / 100) {
// 				i2c_flash_cnt = 0;
// 				// SEG7 显示
// 				result = I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT1, seg7[cnt + 1]);	
// 				// 显示的位置，高有效								
// 				result = I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2, LeftShift);
			
// 				// 蓝板上的LED，从左到右对应第0~7位，低有效
// 				result = I2C0_WriteByte(PCA9557_I2CADDR, PCA9557_OUTPUT,~LeftShift);
