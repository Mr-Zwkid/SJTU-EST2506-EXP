...
// // Systick软定时
// volatile uint16_t   systick_10ms_couter = 0, systick_100ms_couter = 0;
...
// 			{
// 				i2c_flash_cnt = 0;
// 				result = I2C0_WriteByte(TCA6424_I2CADDR, TCA6424_OUTPUT_PORT1, seg7[cnt + 1]);	// 数码管				
// 				result = I2C0_WriteByte(TCA6424_I2CADDR, TCA6424_OUTPUT_PORT2, rightshift);	    // 数码管显示位置 高有效 从左到右为0~7位
		
// 				result = I2C0_WriteByte(PCA9557_I2CADDR, PCA9557_OUTPUT, ~rightshift);	// LED 低有效 从左到右为0~7位
